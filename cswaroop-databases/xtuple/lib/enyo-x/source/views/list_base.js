    ...
    */
    ...
    modelChanged: function (inSender, inEvent) {
      ...
      if ((workspace && inEvent && workspace.prototype.model === inEvent.model &&
          value && typeof Klass === "function") || (this.kind === "XV.ActivityList" &&
          inEvent.updateActivityList && inEvent.uuid)) {
        if (this.kind === "XV.ActivityList") {
          //this.refreshModel(inEvent.uuid, inEvent.done);
          this.fetchRelatedModels({key: inEvent.id});
        } else {

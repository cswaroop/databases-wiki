...
CREATE TABLE STATS_EVENT_PARAM (
    ID bigint NOT NULL,
    PARAM_NAME varchar(127),
...
CREATE TABLE MAIL_GLOBAL_HANDLER (
    CREATED_TIMESTAMP bigint DEFAULT 0,
    HANDLER_TYPE varchar(255),
    ID integer NOT NULL,
    MODULE_COMPLETE_KEY varchar(255),
    UPDATED_TIMESTAMP bigint DEFAULT 0
);

CREATE TABLE MAIL_HANDLER (
    CREATED_TIMESTAMP bigint DEFAULT 0,
    HANDLER_TYPE varchar(255),
    ID integer NOT NULL,
...
CREATE TABLE MAIL_ITEM_AUDIT (
    CREATED_TIMESTAMP bigint DEFAULT 0,
    FROM_ADDRESS varchar(255),
    HANDLER_NAME_KEY varchar(255),
    ID integer NOT NULL,
    ISSUE_KEY varchar(255),
    MAIL_CHANNEL_ID integer DEFAULT 0,
    MAIL_CHANNEL_NAME varchar(255),
...
CREATE TABLE MAIL_RUN_AUDIT (
    ...
    MAIL_CONNECTION_ID integer DEFAULT 0 NOT NULL,
    NO_OF_RETRY integer DEFAULT 0,
    RUN_OUTCOME varchar(255),
    UPDATED_TIMESTAMP bigint DEFAULT 0
);

CREATE TABLE MESSAGE (
    CLAIMANT varchar(127),
...
CREATE TABLE QUEUE (
    ...
    PURPOSE varchar(450) NOT NULL,
    TOPIC varchar(255)
);

CREATE TABLE QUEUE_PROPERTY (
    ID bigint NOT NULL,
    QUEUE_ID bigint NOT NULL,
    LONG_VALUE bigint,
    NAME varchar(450) NOT NULL,
...
CREATE TABLE CUSTOM_CONTENT_LINK (
...
CREATE TABLE NOTIF_BATCH_QUEUE (
    AUTHOR_ID bigint,
    CONTEXT varchar(63),
...
CREATE TABLE OUT_EMAIL_SETTINGS (
    CSS text,
...
CREATE TABLE ASYNCUPGRADE_RECORD (
...
CREATE TABLE CONFLUENCE_KB (
    APPLINKS_APPLICATION_ID varchar(63),
    APPLINK_NAME varchar(255),
    APPLINK_URL text,
    ID integer NOT NULL,
    SERVICE_DESK_ID integer NOT NULL,
...
CREATE TABLE CUSTOM_GLOBAL_THEME (
    CONTENT_LINK_COLOR varchar(255),
    CONTENT_TEXT_COLOR varchar(255),
    CUSTOM_CSS text,
    HEADER_BADGE_BGCOLOR varchar(255),
    HEADER_BGCOLOR varchar(255),
    HEADER_LINK_COLOR varchar(255),
    HEADER_LINK_HOVER_BGCOLOR varchar(255),
    HEADER_LINK_HOVER_COLOR varchar(255),
    HELP_CENTER_TITLE varchar(255),
    ID integer NOT NULL,
    LOGO_ID integer
);
...
CREATE TABLE EMAIL_CHANNEL_SETTING (
    EMAIL_ADDRESS varchar(255),
    ID integer NOT NULL,
    LAST_PROCEEDED_TIME bigint,
    MAIL_CHANNEL_KEY varchar(255) NOT NULL,
    ON_DEMAND boolean,
...
CREATE TABLE GROUP_TO_REQUEST_TYPE (
    GROUP_ID integer,
    ID integer NOT NULL,
    ORDER integer,
...
CREATE TABLE SERIES (
    ...
    JQL text,
    REPORT_ID integer,
    SERIES_DATA_TYPE varchar(255),
    SERIES_LABEL varchar(63),
